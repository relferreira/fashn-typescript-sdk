import fs from 'fs';
import type { ResponseLike } from 'scribo-fashn-ai/internal/to-file';
import { toFile } from 'scribo-fashn-ai/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('scribo-fashn-ai/core/uploads');
    await expect(
