# Scribo Fashn AI TypeScript API Library
...
```sh
npm install git+ssh://git@github.com:relferreira/fashn-typescript-sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/relferreira/fashn-typescript-sdk/issues) with questions, bugs, or suggestions.
